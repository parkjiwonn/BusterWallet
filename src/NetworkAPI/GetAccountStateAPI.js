...
export async function getBusterAccountState(accountId) {
    try {   
        const response = await fetch('http://221.148.25.26:4000/getAccountState', {
            method: 'POST',
            headers: {
...
export async function getNearAccountState(accountId) {
    try {
        const response = await fetch(`http://221.148.25.26:4000/near/getState?account=${accountId}`);
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
        const data = await response.json();
...
export async function getBitTestState(address) {
    try {
        const response = await fetch(`http://221.148.25.26:4000/bitcoin/getStateTestnet?address=${address}`);
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
        const data = await response.json();
...
export async function getEthState(address, network) {
    try {
        const response = await fetch(`http://221.148.25.26:4000/ethereum/getState?network=${network}&account=${address}`);
        if (!response.ok) {
            throw new Error('Network response was not ok');
        }
        const data = await response.json();
